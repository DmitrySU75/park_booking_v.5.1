...
class OrderTable extends Entity\DataManager
{
    ...
    public static function getMap()
    {
        return [
            ...
            new Entity\StringField('ORDER_NUMBER', ['required' => true, 'unique' => true]),
            new Entity\IntegerField('PAVILION_ID', ['required' => true]),
            new Entity\StringField('PAVILION_NAME'),
            new Entity\StringField('LEGAL_ENTITY', ['required' => true]),
            new Entity\StringField('CLIENT_NAME', ['required' => true]),
            new Entity\StringField('CLIENT_PHONE', ['required' => true]),
            new Entity\StringField('CLIENT_EMAIL'),
            new Entity\StringField('CLIENT_TG_ID'),
            new Entity\DatetimeField('START_TIME', ['required' => true]),
            new Entity\DatetimeField('END_TIME', ['required' => true]),
            ...
            new Entity\FloatField('DEPOSIT_AMOUNT', ['required' => true]),
            new Entity\FloatField('DISCOUNT_AMOUNT'),
            new Entity\StringField('DISCOUNT_CODE'),
            new Entity\StringField('STATUS', ['required' => true, 'default_value' => 'pending']),
            new Entity\StringField('PAYMENT_ID'),
            new Entity\StringField('PAYMENT_STATUS', ['default_value' => 'pending']),
            new Entity\FloatField('PAID_AMOUNT', ['default_value' => 0]),
            ...
            new Entity\DatetimeField('CREATED_AT', ['default_value' => new Type\DateTime()]),
            new Entity\DatetimeField('UPDATED_AT', ['default_value' => new Type\DateTime()]),
